package com.posthub.iam_service.kafka;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.posthub.iam_service.kafka.model.utils.PostHubService;
...
public class MessageProducer {
    ...
    public void sendLogs(@NotNull @Valid UtilMessage message) {
        ...
        try {
            ...
            log.debug("Kafka {} message sent. Topic: '{}', message '{}'", message.getActionType(), logsOutTopic, message);
        } catch (Exception exception) {
            log.error("Kafka message didn't sent. ", exception);
        }
    }
